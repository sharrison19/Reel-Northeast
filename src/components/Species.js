...
const Species = () => {
  ...
  const fishSpecies = [
    ...
    },
    {
      ...
      category: "saltwater",
      description:
        "Mackerel is a fast-swimming species that forms large schools, making it a popular target for both commercial and recreational fishing. It is often used in various culinary preparations, such as grilling, smoking, or pickling. With its abundance and delicious taste, mackerel offers a thrilling fishing experience and a delightful addition to any seafood dish.Mackerel is not only sought after for its culinary qualities but also highly valued as bait in the Northeast. Its oily and strongly scented flesh makes it an excellent choice for attracting larger predatory fish species. Anglers often use fresh or frozen mackerel as bait when targeting species like striped bass, bluefish, tuna, or shark. Mackerel can be cut into chunks, filleted, or used whole on fishing hooks to entice and lure these game fish.",
